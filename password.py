...
# Tệp .secret-key.txt sẽ không còn được sử dụng nữa
...
def generate_key():
    """Generates a new random key in memory."""
    return base64.urlsafe_b64encode(os.urandom(32)).decode('utf-8')

# --- Logic cũ về đọc/ghi file đã được loại bỏ ---
...
# Luôn tạo một khóa mới mỗi khi server khởi động
